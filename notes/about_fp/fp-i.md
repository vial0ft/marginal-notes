...
Основная идея: показать максимально **laguage-agnostic** реализации функций, которые встречаются во многих языках, особенно с доминированием функционального подхода к написанию кода.  
...
Теперь заменим `map` в нашем [[Функции в FP I#Пример|примере]] на `flatMap`
